...
- 代码一体化自动生成
- 独创：超有好的接口文档，免除和前端的接口对接工作，例如：
  - ![image-20211009134519385](https://image.qianlong168.cn/uPic/image-20211009134519385.png)
- 独创：接口文档自动生成并更新，无需执行 swag init
  - 注意：只有在 `local` 环境下，以及配置了`project.home`和`docs.path`环境变量情况下，才会更新接口文档。所以，若改变了接口，或者执行了代码生成更新了代码，请本地启动一次项目，使自动更新文档，再编译发布，否则接口文档可能不新鲜（编译操作不会更新接口文档）。
